		...
		public void run() {
			...
			for (int i = 0; i < c.getCount(); i++) {
				...
				if (qty > c.getInt(5)) {
				     ...
				     * c.getString(1));
				     * intent.putExtra("packageDetails",
				     * result); intent.putExtra("courierCode",
				     * c.getString(3));
				     * intent.putExtra("courierName",
				     * c.getString(2));
				     * intent.putExtra("monitor",
				     * c.getString(4)); PendingIntent
				     * contentIntent = PendingIntent
				     * .getActivity(MonitorService.this, 0,
				     * intent, 0);
